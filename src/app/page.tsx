          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <div className="lg:col-span-7 space-y-8 relative">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div className="pt-2">
                  <span className="text-foreground">Using Advanced</span>
                </div>
                <div className="pt-2">
              ...
              <p className="text-xl text-muted-foreground w-2/3">
                Connect with our AI assistant to receive customized diet plans and workout routines tailored specifically to your needs.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Button
                  size="lg"
                  asChild
                  className="overflow-hidden bg-primary text-primary-foreground px-8 py-6 text-lg font-medium hover:bg-purple-500"
                >
